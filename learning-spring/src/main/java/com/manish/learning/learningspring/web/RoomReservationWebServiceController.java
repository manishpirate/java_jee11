...
import com.manish.learning.learningspring.business.service.ReservationService;
...
public class RoomReservationWebServiceController {
    ...
    @GetMapping
    public List<RoomReservation> getRooomReservations(@RequestParam(name="date", required = false) String dateString){
